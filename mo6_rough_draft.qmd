...
The compound soceital and economic issues inflicted upon a community by a terrorist attack are profound, and leave lasting scars that affect the stablility of a region. Predicting terrorist attacks and establishing a model that connects terrorist actors to outcomes is a much-researched problem with often no clear solution [@wani2024review]. However, as statistical learning has rapidly opened new research pathways into modeling existing data sources, new options for research have emerged. A key weakness in research into terrorism is data quality: the 'missingness' of data is an inherrent issue with documenting real world events, particularly violent ones where denial and dception methods are employed to hamper law enforcement. The greatest difficulty for law enforcement is the proactive dientification and capture of the "Lone Wolf" terrorist, who acts alone and does not reveal thieir plans before their attack. In this paper, I examine the efficacy of using Data Imputation to synthesize and classify data from the Global Terrorism Database (GTD), with a focus on identifying the number of perpetrators involved in a terrorist attack. I sought to explore the difference in lethality, tactics, and outcomes of individuals performing attacks by themselves as compared to attacks perpetuated by multiple attackers.

I began by first examining these missing fields and identifying candidates for imputation with the Global Terrorism Database. Then, after categorizing attacks by individual, small and large groups, I examine the outcomes, tactics, and methods employed by individuals, producing a lens through which the impact and profile of "Lone Wolves" can be approached by counterterrorism researchers.
...
#| eval: false # rely on existing environment for speedy rendering
